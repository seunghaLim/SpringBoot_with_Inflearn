...
public class ApplicationContextExtendsFindTest {
    ...
    @Configuration // 부모가 DiscountPolicy로 동일한 두 스프링 빈을 임의로 등록
    ...
    @Test //(타입으로 조회 시 동일한 타입이 둘 이상인 경우의 연장선)
    @DisplayName("부모 타입으로 조회 시, 자식이 둘 이상 있으면 중복 오류가 뜸")
